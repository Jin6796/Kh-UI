//  자료형
/*
    원시형(primative type) - 단일 데이터            > stack 공간에 담긴다.
    문자, 숫자, 논리형, undefined - 변수를 선언하고 값을 할당하지 않으면 undefined가 저장됨

    참조형(reference type) - 복합 데이터{key:value} > heap 공간에 담긴다.
    {
      id: 'tomato', pw: '123'
    }
    : 값이 위치하고 있는 참조 주소값만 메모리에 저장 - 함수도 객체이다
    null    - 특정 변수의 값을 비워둘 때 사용
